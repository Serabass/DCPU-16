            ...
            if (op.opcode >= 0x10 && op.opcode <= 0x17) {
                ...
                if (op.a_immediate === undefined) {
                    ...
                    switch (op.opcode) {
                        ...
                        case 0x05:
                        {
                            res.branch = (DCPU.extendSign(offset) * DCPU.extendSign(op.a_immediate)) & 0xffff;
                            break;
                        }
                        case 0x06:
                        {
                            res.branch = parseInt(offset / op.a_immediate) & 0xffff;
                            break;
                        }
                        case 0x07:
                        {
                            res.branch = parseInt(DCPU.extendSign(offset) / DCPU.extendSign(op.a_immediate)) & 0xffff;
                            break;
                        }
                        case 0x08:
                        {
                        ...
                        case 0x0d:
                        {
                            res.branch = (DCPU.extendSign(offset) >> op.a_immediate) & 0xffff;
                            break;
                        }
                        case 0x0e:
                        {
