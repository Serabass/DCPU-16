...
<div id="controls" class="fl_r">
    <button onclick="run(this)" id="button_run" class="big green"/>
    &#8595; Run (F5)</button>
    <button onclick="step()" class="big"/>
    &#8618; Step (F6)</button>
    <button onclick="reset()" class="big">&#8634; Reset (Esc)</button>
</div>
<div id="cycles_wrap" class="editor fl_r">
    <div class="reg_name fl_l">Cycles:</div>
    <div id="cycles" class="reg_value fl_l">0</div>
</div>
<div id="header">
    <h3>DCPU-16 Assembler, Emulator &amp; Disassembler<span class="notice">by deNULL. In case of problems, write at <a
                href="mailto:me@denull.ru">me@denull.ru</a> or use <a href="/old/">the old version</a>.</span></h3>
...
<div id="info_panel" class="fl_r">
    ...
    <div id="registers" class="editor">
        <div class="reg_name fl_l">PC:</div>
        <div id="regPC" class="reg_value fl_l">0</div>
        <div class="reg_name fl_l">SP:</div>
        <div id="regSP" class="reg_value fl_l">0</div>
        <div class="reg_name fl_l">IA:</div>
        <div id="regIA" class="reg_value fl_l">0</div>
        <div class="reg_name fl_l">EX:</div>
        <div id="regEX" class="reg_value fl_l">0</div>

        <div class="reg_name fl_l clear">A:</div>
        <div id="regA" class="reg_value fl_l">0</div>
        <div class="reg_name fl_l">B:</div>
        <div id="regB" class="reg_value fl_l">0</div>
        <div class="reg_name fl_l">C:</div>
        <div id="regC" class="reg_value fl_l">0</div>

        <div class="reg_name fl_l clear">X:</div>
        <div id="regX" class="reg_value fl_l">0</div>
        <div class="reg_name fl_l">Y:</div>
        <div id="regY" class="reg_value fl_l">0</div>
        <div class="reg_name fl_l">Z:</div>
        <div id="regZ" class="reg_value fl_l">0</div>

        <div class="reg_name fl_l clear">I:</div>
        <div id="regI" class="reg_value fl_l">0</div>
        <div class="reg_name fl_l">J:</div>
        <div id="regJ" class="reg_value fl_l">0</div>
    </div>
...
<div id="tab0_content">
    ...
    <div class="column">
        ...
        <div class="editor" id="asm_code" wrap="off" spellcheck="false" onkeyup="assemble()" onkeydown="assemble()"
             onselect="assemble()" onkeypress="assemble()" onmouseup="assemble()" onchange="assemble()"
             contentEditable="true" autocomplete="off"><?php
            $default_code = <<<EOF
...
<div id="tab1_content">
    ...
    <div class="editor" id="dasm_dump" wrap="off" spellcheck="false" onkeyup="disassemble()" onkeydown="disassemble()"
         onselect="disassemble()" onkeypress="disassemble()" onmouseup="disassemble()" onchange="disassemble()"
         contentEditable="true" autocomplete="off"></div>
</div>
